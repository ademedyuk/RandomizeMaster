...
public enum Screen {
    ...
    _800x600(new ScreenProperties(800,600, 30)
    ...
    _1024x768(new ScreenProperties(1024,768, 35)
    ...
    _1366x768(new ScreenProperties(1366,768, 40)
    ...
    _1920x1080(new ScreenProperties(1920,1080, 55)
    ...
    Screen(ScreenProperties properties){
